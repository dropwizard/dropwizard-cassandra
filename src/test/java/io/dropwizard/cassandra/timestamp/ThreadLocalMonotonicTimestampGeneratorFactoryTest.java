...
class ThreadLocalMonotonicTimestampGeneratorFactoryTest {
    ...
    void shouldBuildAnAtomicMonotonicTimestampGenerator() throws URISyntaxException, IOException,
        ...
        final File yml = new File(Resources.getResource("smoke/timestamp/thread-local.yaml")
                .toURI());
    ...
    void isDiscoverable() {
        assertThat(new DiscoverableSubtypeResolver().getDiscoveredSubtypes(),
                hasItem(ThreadLocalMonotonicTimestampGeneratorFactory.class));
    }
}
